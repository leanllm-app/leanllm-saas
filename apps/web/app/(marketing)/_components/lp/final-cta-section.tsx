...
export function FinalCtaSection() {
  return (
    <section className="mx-auto w-full max-w-7xl bg-white px-4 pb-24 pt-6 sm:px-8 sm:pt-10 md:px-10">
      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-[#507afe]/20 bg-linear-to-br from-[#507afe]/4 via-white to-[#655ccf]/5 px-6 py-12 text-center sm:px-10 sm:py-16">
        <div
          aria-hidden="true"

...
description: "Three modes for handling prompt and response content: metadata-only, masked, or full capture."
...
- **Per-call `redaction_mode=` wins over config.** This is the precedence rule documented in [runtime toggles](/docs-v2/leanllm/runtime-toggles).

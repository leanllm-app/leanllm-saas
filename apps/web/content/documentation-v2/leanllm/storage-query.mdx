---
title: "Storage Query API"
description: "Async read API for fetching, filtering, and counting captured events."
...
- [CLI](/docs-v2/leanllm/cli) — same filters from the shell.
- [Lineage](/docs-v2/leanllm/lineage)
- [Replay](/docs-v2/leanllm/replay)

...
description: "Re-run any captured event through a live model and diff the new response against the original."
...
- [CLI](/docs-v2/leanllm/cli) — `leanllm replay <event_id>` and `--batch`.
